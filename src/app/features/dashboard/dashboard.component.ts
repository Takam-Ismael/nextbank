    ...
    <div class="dashboard">
      ...
      <div class="hero-banner">
        <div class="hero-left">
          ...
          <p class="hero-desc">
            Your platform is performing exceptionally. Revenue is up 12.5% this
            month with 3,420 transactions processed.
          </p>
          <!-- 3 mini stat pills inside hero -->
          <div class="hero-pills">
            <div class="hero-pill">
              <span class="pill-val">24,521</span>
              <span class="pill-label">Active Users</span>
              <span class="pill-change up">+8.2%</span>
            </div>
            <div class="hero-pill">
              <span class="pill-val">385 000 XAF</span>
              <span class="pill-label">Avg. Transaction</span>
              <span class="pill-change up">+4.1%</span>
            </div>
            <div class="hero-pill">
              <span class="pill-val">97.3%</span>
              <span class="pill-label">Approval Rate</span>
              <span class="pill-change up">+0.8%</span>
            </div>
          </div>
        </div>
        <div class="hero-right">
          <p class="hero-rev-label">Total Revenue · 2024</p>
          <p class="hero-rev-val">142 800 000 XAF</p>
